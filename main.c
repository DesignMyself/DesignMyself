...
//#define 	PC8     39
		...
		rt_pin_mode(PB0,PIN_MODE_OUTPUT);//用于电机开关
		rt_pin_mode(PB14,PIN_MODE_OUTPUT);//用于电机开关，高电平时开启
...
void Display2_Init()
{
	...
	D2.PWM=0.0F;
	D2.Input_Ahead_Distance=0.0F;
	D2.Input_Back_Distance=0.0F;
...
{    
	...
	{   
		...
		SetProgressValue(0,1,D1.message,3);
		SetProgressValue(0,31,D2.message,3);
		SetProgress_mess_value(1,4,"",motor1.speed,3);
		SetProgress_mess_value(0,3,"",motor2.speed,3);
		SetProgress_mess_value(0,6,"",motor2.Back_Distance,3);
		SetProgress_mess_value(0,11,"",motor2.Ahead_Distance,3);
		SetProgress_mess_value(1,25,"",motor1.Ahead_Distance,3);
		SetProgress_mess_value(1,23,"",motor1.Back_Distance,3);
		SetProgress_mess_value(1,6,"",motor2.pwm_nopid,3);
		SetProgress_mess_value(1,3,"",D2.Input_Ahead_Distance,3);
		SetProgress_mess_value(1,8,"",motor2.pwm,3);
